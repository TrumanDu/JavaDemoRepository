package com.aibibang.demo.redis.memcalculate;
...
public class Jemalloc {
	 ...
	 * Huge: Extra virtual memory is mapped, then the excess is trimmed and unmapped. This can leave
	...
	public static long min_ge(long[] srcArray, long key) {
		int index = binSearch(srcArray, key);
		return srcArray[index];
	}

	// 二分查找
	public static int binSearch(long srcArray[], long key) {
